...
(() => {
  ...
  const LOGOS = {
    light: "logo-icone-original.png?v=resibulando5",
    dark: "logo-icone-azul-claro.png?v=resibulando5",
    "leila-mood": "logo-icone-rosa-escuro.png?v=resibulando5"
  };
