...
GATE ADVERSARIAL SEM VINHETA: antes de aprovar o item, um revisor independente do gerador deve ignorar os dados clínicos da vinheta e examinar comando + alternativas procurando inferir a chave por forma. Se a chave puder ser prevista com confiança relevante por extensão, completude, prudência, monitorização, linguagem mais profissional ou ausência de absolutos, o item FALHA e deve ser reescrito.
GATE DE ASSIMETRIA LEXICAL: não banir palavras isoladas; detectar assimetria. Se dois ou mais distratores concentrarem universalizadores/absolutos ('sempre', 'nunca', 'todo', 'qualquer', 'somente', 'apenas', 'obrigatoriamente', 'necessariamente', 'prova', 'exclui', 'permanentemente') enquanto a correta for a única opção condicional, contextualizada ou prudente, REESCREVER salvo quando essa distinção for precisamente o conhecimento testado.
GATE DE ELIMINAÇÃO SUPERFICIAL: se duas ou três alternativas caírem sem uso material da vinheta, por absurdo, categoria errada, negligência ou tom formal, REESCREVER salvo item fácil deliberadamente direto e ainda clinicamente homogêneo.
...
GATE CONTRAFACTUAL DO MELHOR DISTRATOR: identificar o melhor distrator e completar internamente 'se X da vinheta mudasse para Y, este distrator passaria a ser correto ou claramente mais defensável'. Se isso não puder ser feito de forma clinicamente coerente em item médio/difícil, o distrator é fraco e deve ser reescrito.
GATE DE RELEVÂNCIA: cada dado clínico/laboratorial destacado deve apoiar ou afastar diagnóstico, mudar gravidade, prioridade, indicação, contraindicação, timing, sequência, cálculo ou decisão. Remover pseudo-contextualização e dados decorativos.
