...
GATE SERIAL DE GABARITO: além da distribuição marginal A-D, analisar a ORDEM da sequência. Bloquear periodicidade mecânica (ex.: ABCDABCD...), alternância previsível, ciclos curtos repetidos, runs anormais e outras estruturas detectáveis. Corrigir apenas por reembaralhamento das alternativas após o conteúdo estar fechado; nunca ajustar a medicina para fabricar letras.
...
- verificar a sequência das letras, não apenas o histograma; periodicidade mecânica, alternância previsível ou ciclo curto repetido faz o lote FALHAR até novo reembaralhamento;
