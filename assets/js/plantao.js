(() => {
  ...
  const GENERIC_ACTIONS = [
    ...
    {id:"exam_head",label:"Cabeça e pescoço",category:"exame",subgroup:"03 · Cabeça e pescoço",time_min:.5,points:0,result:"Crânio normocefálico, sem lesões ou deformidades aparentes. Pescoço sem rigidez, massas, turgência jugular ou sinais externos de trauma."},
    {id:"exam_airway",label:"Vias aéreas",category:"exame",subgroup:"04 · Vias aéreas",time_min:.5,points:0,result:"Vias aéreas patentes, sem secreções, edema ou trauma aparente; sem estridor ou sinais de obstrução."},
    {id:"exam_eyes",label:"Olhos e pupilas",category:"exame",subgroup:"05 · Olhos",time_min:.5,points:0,result:"Olhos sem hiperemia ou lesões aparentes; pupilas isocóricas e fotorreagentes, motilidade ocular extrínseca preservada."},
    {id:"exam_chest",label:"Tórax",category:"exame",subgroup:"06 · Tórax",time_min:.5,points:0,result:"Tórax simétrico, expansibilidade preservada bilateralmente, sem deformidades aparentes; murmúrio vesicular presente bilateralmente, sem ruídos adventícios."},
    {id:"exam_upper",label:"Membros superiores",category:"exame",subgroup:"07 · Membros superiores",time_min:.5,points:0,result:"Membros superiores simétricos, sem deformidades ou edema; pulsos periféricos palpáveis e simétricos, perfusão preservada."},
    {id:"exam_abdomen",label:"Abdômen",category:"exame",subgroup:"08 · Abdômen",time_min:.5,points:0,result:"Abdômen plano, flácido, ruídos hidroaéreos presentes, indolor à palpação superficial e profunda, sem defesa, rigidez ou massas palpáveis."},
    {id:"exam_lower",label:"Membros inferiores",category:"exame",subgroup:"09 · Membros inferiores",time_min:.5,points:0,result:"Membros inferiores simétricos, sem deformidades ou edema; panturrilhas livres, pulsos periféricos palpáveis e simétricos."},
    {id:"exam_extremities",label:"Extremidades e perfusão",category:"exame",subgroup:"10 · Extremidades",time_min:.5,points:0,result:"Extremidades aquecidas, perfundidas, pulsos periféricos palpáveis e simétricos, enchimento capilar inferior a 2 segundos."},
    {id:"exam_skin",label:"Pele e mucosas",category:"exame",subgroup:"11 · Pele",time_min:.5,points:0,result:"Pele íntegra, normocorada e sem lesões aparentes; mucosas úmidas e coradas, sem cianose ou icterícia."},
    {id:"exam_gyne",label:"Exame ginecológico",category:"exame",subgroup:"12 · Ginecológico",time_min:1,points:0,result:"Exame ginecológico realizado. Inspeção vulvovaginal, exame especular e toque bimanual avaliados conforme o contexto clínico do caso."},
    {id:"exam_gu",label:"Exame genitourinário",category:"exame",subgroup:"13 · Genitourinário",time_min:1,points:0,result:"Exame genitourinário realizado. Genitais externos, região inguinal e achados urinários/genitais pertinentes avaliados conforme o contexto clínico do caso."},
