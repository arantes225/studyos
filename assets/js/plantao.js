(() => {
  ...
  const GENERIC_ACTIONS = [
    ...
    {id:"metoprolol",label:"Metoprolol",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Metoprolol administrado.",satisfies:["propranolol","esmolol","beta_blocker"]},
    ...
    {id:"propranolol",label:"Propranolol",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Propranolol administrado.",satisfies:["metoprolol","esmolol","beta_blocker"]},
    {id:"esmolol",label:"Esmolol",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Esmolol administrado.",satisfies:["metoprolol","propranolol","beta_blocker"]},
    ...
    /* Exames adicionais — catálogo ampliado */
    {id:"type_screen",label:"Tipagem sanguínea e pesquisa de anticorpos",category:"laboratorio",subgroup:"Hemoterapia",time_min:.5,points:0,result:"Tipagem sanguínea e pesquisa de anticorpos disponíveis."},
    {id:"crossmatch",label:"Prova de compatibilidade / reserva de hemácias",category:"laboratorio",subgroup:"Hemoterapia",time_min:.5,points:0,result:"Prova de compatibilidade realizada e hemocomponentes reservados."},
    {id:"reticulocytes",label:"Reticulócitos",category:"laboratorio",subgroup:"Hematologia",time_min:.5,points:0,result:"Contagem de reticulócitos disponível."},
    {id:"peripheral_smear",label:"Esfregaço de sangue periférico",category:"laboratorio",subgroup:"Hematologia",time_min:.5,points:0,result:"Esfregaço periférico disponível para interpretação."},
    {id:"haptoglobin",label:"Haptoglobina",category:"laboratorio",subgroup:"Hematologia",time_min:.5,points:0,result:"Haptoglobina disponível."},
    {id:"ferritin",label:"Ferritina",category:"laboratorio",subgroup:"Hematologia",time_min:.5,points:0,result:"Ferritina disponível."},
    {id:"esr",label:"VHS",category:"laboratorio",subgroup:"Inflamatórios",time_min:.5,points:0,result:"VHS disponível."},
    {id:"ionized_calcium",label:"Cálcio ionizado",category:"laboratorio",subgroup:"Eletrólitos",time_min:.5,points:0,result:"Cálcio ionizado disponível."},
    {id:"serum_osmolality",label:"Osmolalidade sérica",category:"laboratorio",subgroup:"Metabólicos",time_min:.5,points:0,result:"Osmolalidade sérica disponível."},
    {id:"beta_hydroxybutyrate",label:"Beta-hidroxibutirato",category:"laboratorio",subgroup:"Metabólicos",time_min:.5,points:0,result:"Beta-hidroxibutirato disponível."},
    {id:"cortisol",label:"Cortisol sérico",category:"laboratorio",subgroup:"Endócrinos",time_min:.5,points:0,result:"Cortisol sérico disponível."},
    {id:"free_t3",label:"T3 livre",category:"laboratorio",subgroup:"Endócrinos",time_min:.5,points:0,result:"T3 livre disponível."},
    {id:"ammonia",label:"Amônia sérica",category:"laboratorio",subgroup:"Hepáticos",time_min:.5,points:0,result:"Amônia sérica disponível."},
    {id:"acetaminophen_level",label:"Dosagem sérica de paracetamol",category:"laboratorio",subgroup:"Toxicologia",time_min:.5,points:0,result:"Dosagem sérica de paracetamol disponível."},
    {id:"salicylate_level",label:"Dosagem sérica de salicilato",category:"laboratorio",subgroup:"Toxicologia",time_min:.5,points:0,result:"Dosagem sérica de salicilato disponível."},
    {id:"carboxyhemoglobin",label:"Carboxi-hemoglobina",category:"laboratorio",subgroup:"Toxicologia",time_min:.5,points:0,result:"Carboxi-hemoglobina disponível."},
    {id:"methemoglobin",label:"Meta-hemoglobina",category:"laboratorio",subgroup:"Toxicologia",time_min:.5,points:0,result:"Meta-hemoglobina disponível."},
    {id:"respiratory_pcr",label:"Painel viral respiratório por PCR",category:"laboratorio",subgroup:"Microbiologia",time_min:.5,points:0,result:"Painel viral respiratório coletado."},
    {id:"sputum_culture",label:"Cultura de escarro",category:"laboratorio",subgroup:"Microbiologia",time_min:.5,points:0,result:"Cultura de escarro coletada."},
    {id:"csf_analysis",label:"Líquor: celularidade, proteína e glicose",category:"laboratorio",subgroup:"Líquor",time_min:.5,points:0,result:"Análise bioquímica e citológica do líquor disponível."},
    {id:"csf_culture",label:"Cultura / Gram do líquor",category:"laboratorio",subgroup:"Líquor",time_min:.5,points:0,result:"Gram e cultura do líquor solicitados."},
    {id:"urine_protein_creatinine",label:"Relação proteína/creatinina urinária",category:"laboratorio",subgroup:"Função renal",time_min:.5,points:0,result:"Relação proteína/creatinina urinária disponível."},
    {id:"anti_xa",label:"Atividade anti-Xa",category:"laboratorio",subgroup:"Coagulação",time_min:.5,points:0,result:"Atividade anti-Xa disponível."},
    {id:"ct_pulmonary_angiography",label:"Angio-TC de artérias pulmonares",category:"imagem",subgroup:"Tomografia",time_min:6,points:0,result:"Angio-TC pulmonar realizada."},
    {id:"cta_aorta",label:"Angio-TC de aorta",category:"imagem",subgroup:"Tomografia",time_min:6,points:0,result:"Angio-TC da aorta realizada."},
    {id:"cta_abdomen_pelvis",label:"Angio-TC de abdome e pelve",category:"imagem",subgroup:"Tomografia",time_min:6,points:0,result:"Angio-TC de abdome e pelve realizada."},
    {id:"ct_renal_colic",label:"TC sem contraste para litíase urinária",category:"imagem",subgroup:"Tomografia",time_min:5,points:0,result:"TC sem contraste para litíase urinária realizada."},
    {id:"ct_face",label:"Tomografia de face",category:"imagem",subgroup:"Tomografia",time_min:5,points:0,result:"Tomografia de face realizada."},
    {id:"xray_pelvis",label:"Raio-X de pelve",category:"imagem",subgroup:"Radiografia",time_min:1,points:0,result:"Radiografia de pelve realizada."},
    {id:"xray_extremity",label:"Raio-X de extremidade",category:"imagem",subgroup:"Radiografia",time_min:1,points:0,result:"Radiografia da extremidade selecionada realizada."},
    {id:"us_ruq",label:"Ultrassonografia de hipocôndrio direito / vias biliares",category:"imagem",subgroup:"Ultrassom",time_min:4,points:0,result:"Ultrassonografia hepatobiliar realizada."},
    {id:"venous_doppler_leg",label:"Doppler venoso de membros inferiores",category:"imagem",subgroup:"Ultrassom",time_min:4,points:0,result:"Doppler venoso de membros inferiores realizado."},
    {id:"carotid_doppler",label:"Doppler de carótidas",category:"imagem",subgroup:"Ultrassom",time_min:4,points:0,result:"Doppler de carótidas realizado."},

    /* Medicamentos adicionais — mais alternativas por classe */
    {id:"lorazepam",label:"Lorazepam",category:"tratamento",subgroup:"Neurológicos",time_min:.25,points:0,result:"Lorazepam administrado.",dose_hint:"4 mg IV; pode repetir uma vez em estado de mal"},
    {id:"procainamide",label:"Procainamida",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Procainamida administrada.",dose_hint:"20–50 mg/min IV até controle, hipotensão ou 17 mg/kg"},
    {id:"digoxin",label:"Digoxina",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Digoxina administrada.",dose_hint:"0,25–0,5 mg IV; completar ataque conforme contexto"},
    {id:"carvedilol",label:"Carvedilol",category:"tratamento",subgroup:"Cardiovasculares",time_min:.25,points:0,result:"Carvedilol administrado.",dose_hint:"3,125–6,25 mg VO; não é fármaco de titulação IV aguda"},
    {id:"captopril",label:"Captopril",category:"tratamento",subgroup:"Anti-hipertensivos",time_min:.25,points:0,result:"Captopril administrado.",dose_hint:"12,5–25 mg VO"},
    {id:"enalaprilat",label:"Enalaprilato",category:"tratamento",subgroup:"Anti-hipertensivos",time_min:.25,points:0,result:"Enalaprilato administrado.",dose_hint:"1,25 mg IV a cada 6 h, conforme indicação"},
    {id:"clonidine",label:"Clonidina",category:"tratamento",subgroup:"Anti-hipertensivos",time_min:.25,points:0,result:"Clonidina administrada.",dose_hint:"0,1–0,2 mg VO"},
    {id:"bumetanide",label:"Bumetanida",category:"tratamento",subgroup:"Diuréticos",time_min:.25,points:0,result:"Bumetanida administrada.",dose_hint:"0,5–1 mg IV"},
    {id:"milrinone",label:"Milrinona",category:"tratamento",subgroup:"Vasoativos",time_min:.25,points:0,result:"Milrinona iniciada.",dose_hint:"0,125–0,75 mcg/kg/min IV"},
    {id:"methylprednisolone",label:"Metilprednisolona",category:"tratamento",subgroup:"Corticoides",time_min:.25,points:0,result:"Metilprednisolona administrada.",dose_hint:"40–125 mg IV conforme indicação"},
    {id:"betamethasone",label:"Betametasona",category:"tratamento",subgroup:"Obstetrícia",time_min:.25,points:0,result:"Betametasona administrada.",dose_hint:"12 mg IM a cada 24 h por 2 doses para maturação fetal"},
    {id:"ampicillin",label:"Ampicilina",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Ampicilina administrada.",dose_hint:"2 g IV conforme indicação"},
    {id:"ampicillin_sulbactam",label:"Ampicilina-sulbactam",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Ampicilina-sulbactam administrada.",dose_hint:"3 g IV"},
    {id:"cefotaxime",label:"Cefotaxima",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Cefotaxima administrada.",dose_hint:"2 g IV a cada 4–8 h conforme indicação"},
    {id:"ceftazidime",label:"Ceftazidima",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Ceftazidima administrada.",dose_hint:"2 g IV a cada 8 h"},
    {id:"cefuroxime",label:"Cefuroxima",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Cefuroxima administrada.",dose_hint:"750 mg–1,5 g IV"},
    {id:"ciprofloxacin",label:"Ciprofloxacino",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Ciprofloxacino administrado.",dose_hint:"400 mg IV ou 500–750 mg VO"},
    {id:"levofloxacin",label:"Levofloxacino",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Levofloxacino administrado.",dose_hint:"500–750 mg IV/VO"},
    {id:"gentamicin",label:"Gentamicina",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Gentamicina administrada.",dose_hint:"5–7 mg/kg IV, ajustar à função renal"},
    {id:"amikacin",label:"Amicacina",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Amicacina administrada.",dose_hint:"15–20 mg/kg IV, ajustar à função renal"},
    {id:"linezolid",label:"Linezolida",category:"tratamento",subgroup:"Antimicrobianos",time_min:.25,points:0,result:"Linezolida administrada.",dose_hint:"600 mg IV/VO a cada 12 h"},
    {id:"amphotericin_b",label:"Anfotericina B",category:"tratamento",subgroup:"Antifúngicos",time_min:.25,points:0,result:"Anfotericina B administrada.",dose_hint:"dose conforme formulação e indicação"},
    {id:"olanzapine",label:"Olanzapina",category:"tratamento",subgroup:"Psiquiátricos",time_min:.25,points:0,result:"Olanzapina administrada.",dose_hint:"5–10 mg VO/IM"},
    {id:"droperidol",label:"Droperidol",category:"tratamento",subgroup:"Psiquiátricos",time_min:.25,points:0,result:"Droperidol administrado.",dose_hint:"2,5–5 mg IM/IV"},
    {id:"octreotide",label:"Octreotida",category:"tratamento",subgroup:"Gastrointestinais",time_min:.25,points:0,result:"Octreotida administrada.",dose_hint:"50 mcg IV bolus; depois 50 mcg/h"},
    {id:"terlipressin",label:"Terlipressina",category:"tratamento",subgroup:"Gastrointestinais",time_min:.25,points:0,result:"Terlipressina administrada.",dose_hint:"2 mg IV; depois 1–2 mg a cada 4–6 h"},
    {id:"mannitol",label:"Manitol",category:"tratamento",subgroup:"Neurológicos",time_min:.25,points:0,result:"Manitol administrado.",dose_hint:"0,5–1 g/kg IV"},
    {id:"hypertonic_saline",label:"Solução salina hipertônica 3%",category:"tratamento",subgroup:"Neurológicos",time_min:.25,points:0,result:"Solução salina hipertônica administrada.",dose_hint:"100–150 mL IV em bolus, conforme indicação"},
    {id:"acetazolamide",label:"Acetazolamida",category:"tratamento",subgroup:"Neurológicos",time_min:.25,points:0,result:"Acetazolamida administrada.",dose_hint:"250–500 mg IV/VO"},
    {id:"desmopressin",label:"Desmopressina",category:"tratamento",subgroup:"Hemostáticos",time_min:.25,points:0,result:"Desmopressina administrada.",dose_hint:"0,3 mcg/kg IV"},
    {id:"vitamin_k",label:"Vitamina K",category:"tratamento",subgroup:"Reversão de anticoagulação",time_min:.25,points:0,result:"Vitamina K administrada.",dose_hint:"5–10 mg IV conforme gravidade"},
    {id:"pcc",label:"Complexo protrombínico (PCC 4 fatores)",category:"tratamento",subgroup:"Reversão de anticoagulação",time_min:.25,points:0,result:"Complexo protrombínico administrado.",dose_hint:"25–50 U/kg IV conforme INR/indicação"},
    {id:"protamine",label:"Protamina",category:"tratamento",subgroup:"Reversão de anticoagulação",time_min:.25,points:0,result:"Protamina administrada.",dose_hint:"1 mg por 100 U de heparina recente, ajustar ao tempo"},
    {id:"idarucizumab",label:"Idarucizumabe",category:"tratamento",subgroup:"Reversão de anticoagulação",time_min:.25,points:0,result:"Idarucizumabe administrado.",dose_hint:"5 g IV"},
    ...
    {id:"lipid_emulsion",label:"Emulsão lipídica IV 20%",category:"tratamento",subgroup:"Antídotos",time_min:.25,points:0,result:"Emulsão lipídica IV administrada.",dose_hint:"1,5 mL/kg bolus; depois infusão conforme protocolo"},
    {id:"calcitonin",label:"Calcitonina",category:"tratamento",subgroup:"Metabólicos",time_min:.25,points:0,result:"Calcitonina administrada.",dose_hint:"4 U/kg SC/IM a cada 12 h"},
    ...
    {id:"paracentesis",label:"Paracentese",category:"procedimentos_terapeuticos",subgroup:"Procedimentos invasivos",time_min:2,points:0,result:"Paracentese realizada."},
    {id:"arthrocentesis",label:"Artrocentese",category:"procedimentos_terapeuticos",subgroup:"Procedimentos invasivos",time_min:2,points:0,result:"Artrocentese realizada e líquido sinovial coletado."},
    {id:"abscess_drainage",label:"Incisão e drenagem de abscesso",category:"procedimentos_terapeuticos",subgroup:"Pequenos procedimentos",time_min:2,points:0,result:"Abscesso incisado e drenado."},
    {id:"wound_irrigation",label:"Irrigação e limpeza de ferida",category:"procedimentos_terapeuticos",subgroup:"Pequenos procedimentos",time_min:1,points:0,result:"Ferida irrigada e limpa."},
    {id:"laceration_suture",label:"Sutura de laceração",category:"procedimentos_terapeuticos",subgroup:"Pequenos procedimentos",time_min:3,points:0,result:"Laceração suturada."},
    {id:"splint",label:"Imobilização com tala",category:"procedimentos_terapeuticos",subgroup:"Ortopedia",time_min:2,points:0,result:"Membro imobilizado com tala."},
    {id:"closed_reduction",label:"Redução fechada de fratura/luxação",category:"procedimentos_terapeuticos",subgroup:"Ortopedia",time_min:2,points:0,result:"Redução fechada realizada e alinhamento reavaliado."},
    {id:"cervical_collar",label:"Imobilização cervical",category:"procedimentos_terapeuticos",subgroup:"Trauma",time_min:.5,points:0,result:"Coluna cervical imobilizada."},
    {id:"nasal_packing_anterior",label:"Tamponamento nasal anterior",category:"procedimentos_terapeuticos",subgroup:"Otorrinolaringologia",time_min:1,points:0,result:"Tamponamento nasal anterior realizado."},
    {id:"nasal_packing_posterior",label:"Tamponamento nasal posterior",category:"procedimentos_terapeuticos",subgroup:"Otorrinolaringologia",time_min:2,points:0,result:"Tamponamento nasal posterior realizado."},
    {id:"sengstaken_blakemore",label:"Balão de Sengstaken-Blakemore",category:"procedimentos_terapeuticos",subgroup:"Hemorragia digestiva",time_min:2,points:0,result:"Balão de tamponamento esofagogástrico posicionado."},
    {id:"endoscopic_hemostasis",label:"Hemostasia endoscópica",category:"procedimentos_terapeuticos",subgroup:"Hemorragia digestiva",time_min:5,points:0,result:"Hemostasia endoscópica realizada."},
    {id:"uterine_balloon",label:"Balão intrauterino para tamponamento",category:"procedimentos_terapeuticos",subgroup:"Hemorragia obstétrica",time_min:2,points:0,result:"Balão intrauterino inserido para tamponamento da hemorragia."},
    {id:"manual_placenta_removal",label:"Extração manual da placenta",category:"procedimentos_terapeuticos",subgroup:"Obstetrícia",time_min:2,points:0,result:"Extração manual da placenta realizada."},
    {id:"uterine_exploration",label:"Revisão manual da cavidade uterina",category:"procedimentos_terapeuticos",subgroup:"Obstetrícia",time_min:2,points:0,result:"Cavidade uterina revisada manualmente."},
    {id:"emergency_hemodialysis",label:"Hemodiálise de urgência",category:"procedimentos_terapeuticos",subgroup:"Terapia renal",time_min:10,points:0,result:"Hemodiálise de urgência iniciada."},
    {id:"continuous_renal_replacement",label:"Terapia renal substitutiva contínua",category:"procedimentos_terapeuticos",subgroup:"Terapia renal",time_min:10,points:0,result:"Terapia renal substitutiva contínua iniciada."},
    {id:"fasciotomy",label:"Fasciotomia",category:"procedimentos_terapeuticos",subgroup:"Cirurgia de emergência",time_min:5,points:0,result:"Fasciotomia realizada."},
    {id:"escharotomy",label:"Escarotomia",category:"procedimentos_terapeuticos",subgroup:"Queimaduras",time_min:4,points:0,result:"Escarotomia realizada."},
    {id:"foreign_body_removal",label:"Retirada de corpo estranho",category:"procedimentos_terapeuticos",subgroup:"Pequenos procedimentos",time_min:2,points:0,result:"Corpo estranho removido."},
    {id:"ocular_irrigation",label:"Irrigação ocular copiosa",category:"procedimentos_terapeuticos",subgroup:"Oftalmologia",time_min:1,points:0,result:"Irrigação ocular copiosa realizada."},
    {id:"lateral_canthotomy",label:"Cantotomia/cantólise lateral",category:"procedimentos_terapeuticos",subgroup:"Oftalmologia",time_min:2,points:0,result:"Cantotomia/cantólise lateral realizada."}
  ];
  ...
  function renderActions() {
    ...
    if(state.category==="intervir"){
      if(!["medicamentos","procedimentos"].includes(state.interventionTab)) state.interventionTab="medicamentos";
